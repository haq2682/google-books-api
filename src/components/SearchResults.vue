<template>
    <div class="division">
        <div class="results">
            <h1 style="padding-top: 20px;" v-show="error">No Results Found</h1>
            <h1 style="padding: 20px;">Search Results</h1>
            <!-- Fetched data is shown in the carousel -->
            <carousel :value="results" :numVisible="5" :numScroll="1">
...
<script>
    ...
    export default {
        ...
        //Props from the parent component 'Search Bar' are defined here
        ...
        methods: {
            //Shows the dialog of the specific volume when clicked upon
            showDialog(item) {
                this.display = true;
                this.currentVolume = item;
                console.log(item);
            },
            //Navigates the user to the Google Books page of the selected volume upon clicking
            navigateToLink(link) {
